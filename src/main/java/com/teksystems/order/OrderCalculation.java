...
public class OrderCalculation {
	...
	public static void main(String[] args) throws Exception {
		...
		// Create order object for each order
		order = new Order();
		...
		order.add(new OrderLine(new Item("packet of headache pills",
				(float) 9.75), 1));
		order.add(new OrderLine(new Item("box of imported chocolates",
				(float) 11.25), 1));
